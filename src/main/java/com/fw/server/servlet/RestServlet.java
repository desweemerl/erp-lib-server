...
import com.fw.server.servlet.annotations.POST_FILE;
import com.fw.server.servlet.annotations.GET;
import com.fw.server.servlet.annotations.DELETE;
import com.fw.server.servlet.annotations.GET_WITH_PARAMS;
import com.fw.server.servlet.annotations.PUT;
import com.fw.server.servlet.annotations.POST;
import com.fw.server.servlet.annotations.GET_WITH_ID;
import com.fw.server.servlet.annotations.Path;
import com.fw.server.exception.JsonException;
import com.fw.server.exception.TextException;
import com.fw.server.exception.UnauthenticatedException;
import com.fw.server.i18n.I18n;
import com.fw.server.security.annotation.Secured;
import com.fw.server.exception.UnauthorizedException;
import com.fw.server.json.JacksonObjectMapper;
import com.fw.server.reports.PdfDocument;
import com.fw.server.routing.FileRequest;
import com.fw.server.routing.FileResponse;
import com.fw.server.routing.RequestFormat;
import com.fw.server.routing.RequestType;
import com.fw.server.routing.ResponseType;
import static com.fw.server.routing.ResponseType.FILE;
import static com.fw.server.routing.ResponseType.PDF;
import static com.fw.server.routing.ResponseType.TEXT;
import com.fw.server.routing.Route;
import com.fw.server.servlet.annotations.Produces;
import com.fw.server.utils.PackageUtil;
import com.fw.server.utils.StringUtil;
import com.lowagie.text.Document;
import com.lowagie.text.pdf.PdfWriter;
import com.fw.server.exception.NotFoundException;
...
public class RestServlet extends HttpServlet {     
    ...
    private Map<String, Route> routesGET = new HashMap();
    private Map<String, Route> routesGET_WITH_ID = new HashMap();
    private Map<String, Route> routesGET_WITH_PARAMS = new HashMap();
    
    private Map<String, Route> routesPOST = new HashMap();
    private Map<String, Route> routesPOST_FILE = new HashMap();
    
    private Map<String, Route> routesPUT = new HashMap();
    
    private Map<String, Route> routesDELETE = new HashMap();
    
    private Pattern urlRegExpId = Pattern.compile(".*\\/[0-9]{1,}$");
    
    private Logger logger = LoggerFactory.getLogger(RestServlet.class);   
    ...
    private void writeJsonException(Route route, HttpServletResponse response, JsonException jsonException) {
        ...
        if (!jsonException.getFields().isEmpty()) {
            ...
            for (String key : jsonException.getFields().keySet()) {
