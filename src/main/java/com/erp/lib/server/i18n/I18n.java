package com.erp.lib.server.i18n;
...
public class I18n {
    ...
    public String getMessage(String message, String language) {
        ...
        try {
            ...
            ResourceBundle resourceBundle = resourceBundle = PropertyResourceBundle
                    .getBundle(configuration.getI18nPackage(), new Locale(language));
